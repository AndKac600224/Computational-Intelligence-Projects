...
| Funkcja przynależności dla Wagi | Funkcja przynależności dla Wzrostu | Funkcja przynależności dla BMI |
|:---:|:---:|:---:|
| ![Wykres 1. Funkcja przynależności dla Wagi](assets/fpweight.png) | ![Wykres 2. Funkcja przynależności dla Wzrostu](assets/fpheight.png) | ![Wykres 3. Funkcja przynależności dla BMI](assets/fpbmi.png) |
